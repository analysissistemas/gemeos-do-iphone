...
/* ---------- ACESSÓRIOS ----------
   ...
   QUANTIDADE: não têm chassi nem quilometragem, um capacete é igual ao outro. */
const CAT_ACES = {
  "Capacete fechado":          {var:["Única"], cor:["Preto"],           base: 180},
  "Capacete aberto":           {var:["Única"], cor:["Preto"],           base: 120},
  "Baú 45 litros":             {var:["Única"], cor:["Preto"],           base: 260},
  "Carregador reserva":        {var:["Única"], cor:["Preto"],           base: 390},
  "Capa de cobrir moto":       {var:["Única"], cor:["Preta"],           base:  70},
